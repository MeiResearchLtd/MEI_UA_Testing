...
//	}
	...
	private void setEnvironment() {
		objtestvars = TestVars.getInstance();
	}
	...
	private void setEnvironment_OLD() {
		...
		if ((System.getProperty("user.dir")).equals(matt)) {
			...
			System.setProperty("webdriver.chrome.driver",
					"C:/Users/eagle/Program Files/chromedriver_win32/chromedriver.exe");
	...
	public void test_Login() {
		...
		// Verify home page
		Assert.assertTrue(objHomePage.getHomePageWelcome().contains(objtestvars.getUserName()));
	...
	public void test_Login_Admin() {
		...
		// System.out.println(objHomePage.getHomePageWelcome().toLowerCase());
		Assert.assertTrue(
				objAdminHomePage.getHomePageWelcome().toLowerCase().contains("system summary and access control"));
		System.out.println("[Test Case]Home Page Verified");
	...
	public void test_Select_New_Project_Name() {
		// Select the new project created in the Create Project From Scratch
		// Test Case
		objHomePage = new PilrHomePage(driver);
	...
	public void test_Select_New_Project() {
		...
		Assert.assertTrue(objHomePage.getHomePageWelcome().toLowerCase()
				.contains("welcome back, " + objtestvars.getUserName() + "!"));
	...
	public void test_Select_EMA_Instrument() {
		...
		objCoordinatePage = new Pilr_CoordinatePage(driver);
		System.out.println(objCoordinatePage.getcoordinatePageWelcome().toLowerCase());
		Assert.assertTrue(objCoordinatePage.getcoordinatePageWelcome().toLowerCase()
				.contains("coordinate participants and data"));
	...
	public void test_Select_EMA_Builder_Page() {
		...
		Assert.assertTrue(objEMABuilderPage.getBuilderPageWelcome2().toLowerCase().contains("ema configurations"));
	}
	...
	public void test_Select_Add_Config_Builder_Page_AgHealth() {
		...
		Assert.assertTrue(
				objImportModal.get_EMA_Config_Defs_Welcome().toLowerCase().contains("create an ema configuration"));
	...
	/*
	 * @Test public void test_Select_Add_Config_Builder_Page(){ objConfigBuilder
	 * = new Pilr_Config_Builder(driver); objImportModal = new
	 * Import_EMA_Defs_Modal(driver); objImportModal.add_NewConfig();
	...
	public void test_Import_Config_Builder_Page() {
		...
		Assert.assertTrue(
				objImportModal.get_EMA_Config_Defs_Welcome().toLowerCase().contains("import ema configurations"));
	}
	...
	public void test_Import_Modal_Import_Ag() {
		...
		Assert.assertTrue(objtestvars.get_EMA_Config_Defs()
				.contains("/Users/matt/Desktop/MEI/ema-configs-standard-surveys-wtriggers.json"));
	...
	public void test_Select_Organization_Page() {
		...
		Assert.assertTrue((objOrgPage.getOrgPageWelcome().toLowerCase().contains("organization settings")));
	}
	...
	public void test_Project_Settings_Admin() {
		...
		Assert.assertTrue(objProjectDetailsAdmin.getProjectDetailsWelcome().toLowerCase().contains("edit"));
	}
	...
	public void test_Delete_Newly_Added_Project() {
		...
		Assert.assertTrue(objOrgPage.getOrgPageWelcome().contains(objtestvars.getOrg()));
	...
	public void test_Delete_Newly_Added_Project_Liad() {
		...
		navbar.Nav_to_Org_Page(pilr_org);
		Assert.assertTrue(objOrgPage.getOrgPageWelcome().contains(objtestvars.getLiadOrg()));
